	...
	<div>
		...
		<div class="nav fl">
			<ul>
                <!-- 一级菜单 -->
				<li>
                    <a href="<c:url value="/WEB-INF/views1/demo/attention.jsp"/>" target="frame">
				...
				<li>
					...
					<div class="div3">
				      <ul>
                          ...
                          <li><a href="/stuCou/listStuCou1" target="frame">小站营运明细</a></li>
				      </ul>
			   		</div>
				</li><!-- 多级菜单结束 -->
        ...
        <iframe src="<c:url value="/WEB-INF/views/demo/attention.jsp"/>" frameborder="0" scrolling="no" name="frame"
                id="ifm" name="ifm" onload="javascript:dyniframesize('ifm');IFrameReSizeWidth('mainFrame');" width="100%" >
        </iframe>
	</div>
</body>
</html>