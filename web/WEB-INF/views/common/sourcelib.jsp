...
<script type="text/javascript" src="<c:url value="/resources/js/iframe.js"/>"></script>
...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/circle.css"/>" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/main.css"/>" />
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/css/zebra_dialog.css"/>" />
